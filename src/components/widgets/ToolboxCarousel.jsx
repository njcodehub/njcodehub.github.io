  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      >
        ...
        <p style={{ color: '#00adb5', fontSize: '0.8rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '4px' }}>
          {coreSkill.subtitle}
        </p>
        <h4 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#222831', marginBottom: '12px' }}>
          {coreSkill.title}
        </h4>
        <p style={{ color: '#393e46', lineHeight: 1.7, marginBottom: '10px' }}>
